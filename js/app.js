...
/* A nodejs webApp the exposes two GSIS SOAP web services
 * as REST endpoints:
 *
 * 1. HTTP GET /version
 * 2. HTTP GET /details?username=YOUR_USERNAME&password=YOUR_PASSWORD
 *                     &vatBy=REQUESTER_VAT&vatFor=QUERY_VAT
 *
 * For more details on the parameters of (2),
 *  see https://github.com/dspinellis/greek-vat-data
 *
